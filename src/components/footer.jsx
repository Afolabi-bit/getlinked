  ...
  return (
    <footer className="bg-[#100B20] pb-[70px]">
      <article className="flex flex-col px-[3rem] py-[70px] bg-[#100B20] lg:mx-[5rem] lg:flex-row lg:justify-between">
        ...
        <div className="md:flex md:items-start md:gap-[100px] lg:gap-0 lg:w-[50%] lg:justify-between">
          <div>
            ...
            <div className="flex items-center gap-[20px] lg:mt-[30px]">
              <span className="text-[#d434fe] text-[12px] font-normal">
                Follow us
              </span>
              <Socials />
            </div>
          ...
          <div className="mt-[35px] md:mt-0">
            ...
            <ul>
              <li className="flex gap-[20px] items-start">
                ...
                <p className="text-[12px] font-normal">+234 6707653444</p>
              </li>
              <li className="flex gap-[20px] mt-[20px] items-start">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="13"
                  height="15"
                ...
                <p className="text-[12px] w-[86px] font-normal">
